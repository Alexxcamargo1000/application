...
export function Desktop() {
  ...
  return (
    ...
    <div className='flex-1 mt-8  px-4 py-5 o overflow-hidden overflow-y-auto scrollbar-thin scrollbar-track-zinc-900 scrollbar-thumb-zinc-800'>
        ...
        <ul className=' text-zinc-300 text-sm max-h-[calc(100vh-2rem)]  capitalize divide-y divide-teal-800 max-h[]'>
      ...
      <CreateNewCategory className="font-semibold leading-none rounded-none flex items-center gap-2 justify-center bg-teal-600 h-14 hover:bg-teal-700 transition-colors" />
    </aside>
  )
}